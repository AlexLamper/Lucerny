  ...
  return (
    <form onSubmit={(e) => onSubmit(e)} className={styles.form}>
      ...
      <div className="formcarry-block">
        ...
        <textarea value={message} onChange={(e) => setMessage(e.target.value)} id="message" placeholder="Licht je wensen zo gedetailleerd toe. Is het voor uw bedrijf of voor u zelf etc..." className={styles.inputTextArea}></textarea>
      </div>
