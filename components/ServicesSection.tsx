const ServicesSection = () => {
  return (
    <section className="bg-lightGray text-black py-20 lg:py-32">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="border rounded-lg p-6 shadow-md">
            ...
            <a
              href="#"
              className="bg-gradient-to-r from-blueButtonStart to-blueButtonEnd hover:bg-blue-600 text-white py-2 px-4 rounded-full text-lg font-semibold transition duration-300 inline-block"
            >
              Meer informatie
            </a>
          </div>
